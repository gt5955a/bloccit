...
RSpec.describe SponsoredPostsController, type: :controller do
  ...
  let(:my_sponsored_post) { my_topic.sponsored_posts.create!(title: random_sentence, body: RandomData.random_paragraph, price: RandomData.random_integer) }
  ...
  describe "POST create" do
    ...
    it "assigns the new sponsored_post to @sponsored_post" do
      post :create, topic_id: my_topic.id, post: { title: RandomData.random_sentence, body: RandomData.random_paragraph, price: RandomData.random_integer }
    end
  ...
  describe "PUT update" do
    ...
    it "redirects to the updated post" do
      ...
      put :update, id: my_sponsored_post, post: { title: new_title, body: new_body, price: new_price }
